...
(function () {
  var I = {
    world: '<circle cx="12" cy="12" r="8.5"/><path d="M3.8 10h16.4M4.6 15.5h14.8M12 3.5c2.1 2.3 3.2 5.1 3.2 8.5S14.1 18.2 12 20.5C9.9 18.2 8.8 15.4 8.8 12S9.9 5.8 12 3.5z"/>',
    ...
    echo: '<path d="M12 2.8 20.5 12 12 21.2 3.5 12 12 2.8z"/><path d="m8.8 12 3.2-3.4 3.2 3.4-3.2 3.4L8.8 12z"/>',
    skytrail: '<path d="M5 21 9.2 4h5.6L19 21"/><path d="M7.3 14h9.4M8.5 9h7"/><path d="m12 2 1 2.2 2.4.3-1.7 1.7.4 2.4L12 7.5 9.9 8.6l.4-2.4-1.7-1.7 2.4-.3L12 2z"/>',
    maze: '<path d="M4 4h6v4H8v4h4V8h4V4h4v7h-4v4h4v5h-8v-4H8v4H4v-8h4"/><circle cx="14" cy="13" r="1.2"/>',
    ...
    forceUpdate: '<path d="M12 3.4v11.4M7.6 10.6 12 15l4.4-4.4M4.6 19.4h14.8"/>',
  ...
  var C = {
    world: ['#6D9384', '#315C58'], new: ['#4A91DE', '#286CB6'], review: ['#7469D1', '#5047A4'], weak: ['#50A46C', '#2F774A'], arcade: ['#5964D8', '#3943A4'], echo: ['#8A78E8', '#3B5FB6'], skytrail: ['#6AAE91', '#315F5A'], maze: ['#B09A64', '#496E68'], quiz: ['#E7A925', '#CE7914'],
    ...
    eye: ['#A58A58', '#71603F'], theme: ['#8E8E93', '#5B5B60'], bright: ['#E0A64B', '#B0741F'], warmth: ['#E08A62', '#B85C34'], rest: ['#5FBE7F', '#2F7A4C'], gameSrc: ['#4AA39A', '#2E7771'], store: ['#5AC8FA', '#287CB8'], assistant: ['#7469D1', '#3B5FB6'], versus: ['#FF6B4A', '#C9342B'], readaloud: ['#E9548C', '#B02463'], rate: ['#A969C4', '#754693'], update: ['#4A91DE', '#286CB6'], forceUpdate: ['#E0A64B', '#B0741F'], reset: ['#DF5A53', '#B83238'],
